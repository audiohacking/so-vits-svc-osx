...
class MyWriter(SummaryWriter):
    ...
    def log_training(self, g_loss, d_loss, mel_loss, stft_loss, k_loss, r_loss, score_loss, vggish_loss, phase_loss, hf_loss, mel_cepstrum_loss, step,current_lr):
        ...
        self.add_scalar('train/mel_cepstrum_loss', mel_cepstrum_loss, step)
        self.add_scalar('train/kl_f_loss', k_loss, step)
        self.add_scalar('train/kl_r_loss', r_loss, step)
        self.add_scalar('train/hf_loss', hf_loss, step)
        self.add_scalar('train/lr', current_lr, step)
